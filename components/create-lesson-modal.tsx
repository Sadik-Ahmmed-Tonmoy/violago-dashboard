// components/create-lesson-modal.tsx (updated)
...
interface CreateLessonModalProps {
  ...
  modalTitle?: string; // NEW: custom modal title
}

export function CreateLessonModal({ open, onClose, onSubmit, modalTitle = "Create New Lesson" }: CreateLessonModalProps) {
  ...
  const handleFormSubmit = async (data: any) => {
    ...
    if (fileList.length > 0) {
      setUploading(true);
      // Simulate upload – replace with actual API call (e.g., to S3)
